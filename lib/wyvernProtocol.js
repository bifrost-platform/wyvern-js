...
var WyvernProtocol = /** @class */ (function () {
     ...
     */
    WyvernProtocol.generateParamsForMatch = function (sell, buy, metadata) {
        var compactAddresses = function (sell, buy) {
            return [
                buy.exchange,
                buy.maker,
                buy.taker,
        ...
        var compactFees = function (sell, buy) {
            return [
                buy.makerRelayerFee,
                buy.takerRelayerFee,
        ...
        var compactMethods = function (sell, buy) {
            return [
                buy.feeMethod,
                buy.side,
                buy.saleKind,
        ...
        return [
            ...
            [
                buy.ecSignature.r || constants_1.constants.NULL_ADDRESS,
                buy.ecSignature.s || constants_1.constants.NULL_ADDRESS,
                sell.ecSignature.r || constants_1.constants.NULL_ADDRESS,
                sell.ecSignature.s || constants_1.constants.NULL_ADDRESS,
                metadata || constants_1.constants.NULL_BLOCK_HASH,
            ],
        ];
    };
    __decorate([
